...
const Form = ({ isSignInPage = true }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await axios
      .post(`${BASE_URL}${isSignInPage ? "login" : "register"}`, data)
      .then((res) => {
  ...
  return (
    <div className="bg-secondary h-screen flex items-center justify-center">
      <div className=" bg-light text-[#EEEEEE] w-[600px] h-[90%] shadow-lg rounded-lg flex flex-col justify-center items-center">
